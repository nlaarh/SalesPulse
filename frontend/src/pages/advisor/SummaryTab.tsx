  ...
  return (
    <>
      ...
      <div className="animate-enter stagger-1 grid grid-cols-5 gap-3">
        {[
          { label: line?.toLowerCase() === 'insurance' ? 'Written Premium' : 'Billed Bookings',    value: formatCurrency(billedValue, true), status: billedValue > 0 ? 'Active' : 'No Data', health: 'strong' as const, detail: `${formatNumber(summary.deals)} won deals`,                               icon: DollarSign, tip: TIPS.billedRevenue },
