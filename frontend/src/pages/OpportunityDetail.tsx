...
export default function OpportunityDetail() {
  ...
  return (
    <div id="opp-print-root" className="space-y-3">
      {/* ── HEADER ── */}
      <div className="animate-enter flex items-start gap-3">
        ...
        <div className="shrink-0 text-right">
          ...
          <div data-no-print className="flex items-center justify-end gap-1.5 mt-2 print:hidden">
            <button onClick={() => printFromDom('opp-print-root', detail.name)}
