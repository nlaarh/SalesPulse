...
const MODULES = [
  { icon: '📊', label: 'Advisor Performance', desc: 'Revenue, leads & team ranking' },
  { icon: '📅', label: 'Monthly Breakdown', desc: 'Agent × month breakdown' },
  { icon: '🎯', label: 'AI-Ranked Deals', desc: 'AI-scored deal ranking' },
  { icon: '🔀', label: 'Sales Pipeline', desc: 'Forecasting & velocity' },
  { icon: '✈️', label: 'Destinations', desc: 'Travel analytics' },
  { icon: '📣', label: 'Lead Funnel & Conversion', desc: 'Conversion & sources' },
]
