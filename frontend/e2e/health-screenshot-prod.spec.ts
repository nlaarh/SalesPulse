...
test('screenshot system health topology on prod', async ({ page }) => {
  page.setViewportSize({ width: 1920, height: 1080 })
  console.log('Navigating to production login page...')
  await page.goto('https://salespulse-nyaaa.azurewebsites.net/login')
  ...
  await page.goto('https://salespulse-nyaaa.azurewebsites.net/settings?tab=system')
